...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        Department info = new Department("INFO", "Informatique", 50000000);
        Department math = new Department("MATH", "Mathematiques", 40000000);
        Department bio  = new Department("BIO",  "Biologie", 35000000);

        System.out.println("── Departments ──");
        System.out.println(info);
        System.out.println(math);
        info.augmenterBudget(500000);
        ...
        Instructor i1 = new Instructor("I001","Toure Mamadou",info,500000);
        Instructor i2 = new Instructor("I002","Bamba Aminata",math,350000);
        i1.addSection(s1);
        i2.addSection(s3);
        ...
        System.out.println(i2.getName() + " → " + Math.round(i2.getSalary()) + " FCFA");
        ...
        System.out.println("500000 FCFA → " + NiveauJava.getCategorieSalaire(500000));
