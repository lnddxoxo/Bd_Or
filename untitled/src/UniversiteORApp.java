...
public class UniversiteORApp {
    ...
    static void afficherMenu() {
        ...
        System.out.println("║  [5] Sections + salle + cours → REF chainee   ║");
        System.out.println("║  [6] Tester IS DANGLING       → integrite REF ║");
        System.out.println("║  [7] Notes par etudiant       → Nested Table  ║");
        System.out.println("║  [8] Info superviseurs        → REF chainee   ║");
        System.out.println("║                                              ║");
    ...
    static void listerInstructeurs() {
        ...
        try (Connection conn = ConnectionManager.getConnection();
             Statement stmt = conn.createStatement();
             ResultSet rs = stmt.executeQuery(sql)) {
            System.out.printf("%-22s %-15s %-15s %s%n",
                    "Instructeur", "Salaire FCFA", "Categorie", "Sections");
    ...
    static void afficherSections() {
        System.out.println("\n── REF chainee : getTitreCours() + getInfoSalle() ──");
        ...
        try (Connection conn = ConnectionManager.getConnection();
            ...
            while (rs.next()) {
                ...
                System.out.println("Passee   : " +
                        (rs.getString(6).equals("1") ? "Oui" : "Non"));
            }
            System.out.println("─".repeat(60));
        } catch (SQLException e) {
            System.out.println("Erreur : " + e.getMessage());
    ...
    static void afficherSuperviseurs() {
        System.out.println("\n── REF chainee : getInfoSuperviseur() ──");
